...
<html>
	...
	<body>
		...
		<form class="box" action="/Doem-2019-12-7/RloginServlet" method="post">
			<img id="chang_img" class="imgcheck" src="/Doem-2019-12-7/sourse/deng_on.png"" />
			<h1>Login</h1>
			...
			<a class="registered" href="/Doem-2019-12-7/jsp/registered.jsp">registered</a><br>
		...
		<script>
			...
			document.getElementById("chang_img").onclick=function(){
				if(flag){
					...
					window.location.href="/Doem-2019-12-7/jsp/login.jsp";
				}else{
					var chang_img=document.getElementById("chang_img");
